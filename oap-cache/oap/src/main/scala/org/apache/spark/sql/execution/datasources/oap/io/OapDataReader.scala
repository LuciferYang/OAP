...
private[oap] class OapDataReaderV1(
  ...
  private val dataFileClassName = DataFileUtils.getDataFileClassFor(meta.dataReaderClassName)
...
object DataFileUtils extends Logging {
  def getDataFileClassFor(dataReaderClassFromDataSourceMeta: String): String = {
